  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="grid gap-5 md:grid-cols-2">
        <div>
          <label className="label" htmlFor="technician">
            Technicien
          </label>
          <select
            id="technician"
      ...
      <div>
        ...
        <input
          ...
          className="block w-full cursor-pointer text-sm text-muted file:mr-4 file:cursor-pointer file:rounded-md file:border-0 file:bg-border file:px-4 file:py-2.5 file:text-sm file:font-medium file:text-fg transition file:duration-150 hover:file:bg-[#ddd]"
        />
        <p className="mt-2 text-xs text-muted">Formats : PNG, JPG. Visible uniquement par le support.</p>
      </div>
